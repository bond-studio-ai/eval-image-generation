...
export function SsmParamsEditor({
  value,
  onChange,
}: {
  value: SsmParamsState;
  onChange: (next: SsmParamsState) => void;
}) {
        ...
        <Field label="Addressables catalog" optional>
          {(id) => (
            <TextInput
              ...
              onChange={(e) => set({ addressablesCatalog: e.target.value })}
        ...
        <Field label="Upload bucket" optional>
          {(id) => (
            <TextInput
              ...
              onChange={(e) => set({ uploadBucket: e.target.value })}
              placeholder="Optional"
            />
          )}
        </Field>
