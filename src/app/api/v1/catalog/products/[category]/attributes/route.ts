...
const TILE_SNAKE = new Set(["floor_tiles", "wall_tiles", "shower_wall_tiles", "shower_floor_tiles", "shower_curb_tiles"] as const satisfies ReadonlyArray<(typeof PRODUCT_CATEGORIES)[number]>);
