...
export default async function GenerationDetailPage({ params }: PageProps) {
  ...
  return (
    <div>
      <Link href="/generations" className="text-sm text-gray-500 hover:text-gray-700">
      ...
      <div className="mt-8">
        ...
        {result.inputImages.length === 0 ? (
          <p className="mt-4 text-sm text-gray-500">No input images for this generation.</p>
        ) : (
      ...
      <div className="mt-8">
        ...
        {result.outputImages.length === 0 ? (
          <p className="mt-4 text-sm text-gray-500">No output images for this generation.</p>
        ) : (
          <div className="mt-4 grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-4">
