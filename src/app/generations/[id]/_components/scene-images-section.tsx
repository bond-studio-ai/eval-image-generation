      ...
      <div className="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-3">
        {dollhouseView && (
          <div className="border-border bg-surface overflow-hidden rounded-lg border shadow-xs">
            <ImageWithSkeleton src={dollhouseView} alt="Dollhouse View" wrapperClassName="h-56 w-full bg-surface-muted" />
            <div className="p-2">
        ...
        {realPhoto && (
          <div className="border-border bg-surface overflow-hidden rounded-lg border shadow-xs">
            <ImageWithSkeleton src={realPhoto} alt="Real Photo" wrapperClassName="h-56 w-full bg-surface-muted" />
            <div className="p-2">
        ...
        {moodBoard && (
          <div className="border-border bg-surface overflow-hidden rounded-lg border shadow-xs">
            <ImageWithSkeleton src={moodBoard} alt="Mood Board" wrapperClassName="h-56 w-full bg-surface-muted" />
            <div className="p-2">
