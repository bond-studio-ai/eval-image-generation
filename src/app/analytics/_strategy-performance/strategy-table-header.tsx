...
const thClass = "px-4 py-3 text-right text-caption font-medium tracking-wider text-text-secondary uppercase cursor-pointer select-none hover:text-text-primary transition-colors";
