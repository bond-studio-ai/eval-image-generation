...
import { buildComparisonSlices, getParamValues, parseComparisonState } from "@/app/analytics/comparison-utils";
...
export default async function AnalyticsPage({ searchParams }: PageProps) {
  ...
  const ratedPct = overview.totalGenerations > 0 ? `${Math.round((overview.ratedGenerations / overview.totalGenerations) * 100)}%` : "0%";

  return (
    <div>
      <PageHeader title="Analytics" subtitle={source === "benchmark" ? "Insights into benchmark generation quality and benchmark performance." : "Insights into generation quality and strategy performance."} />
      <div className="mt-4">
