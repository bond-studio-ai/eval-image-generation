...
export function BatchErrorCard({ error, onRetry, retrying = false }: { error: string; onRetry: () => void; retrying?: boolean }) {
  return (
    <div className="rounded-card border-warning-200 bg-warning-50 flex items-start gap-3 border p-4">
      ...
      <div className="min-w-0 flex-1">
        ...
        <p className="text-caption text-warning-700 mt-1">Ensure BASE_API_HOSTNAME points to the image-generation backend.</p>
        <div className="mt-3">
