...
interface FilterSearchProps extends Omit<InputHTMLAttributes<HTMLInputElement>, "value" | "onChange"> {
  value: string;
 ...
 * filter-bar density.
 */
export function FilterSearch({ value, onChange, placeholder = "Search...", width = "w-72", className, ...rest }: FilterSearchProps) {
  return (
