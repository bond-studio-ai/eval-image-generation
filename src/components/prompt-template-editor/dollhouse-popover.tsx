...
export function DollhousePopover({
  state,
  dispatch,
  filteredProducts,
  customProduct,
          ...
          {!state.product ? (
            <>
              ...
              <div className="border-b border-gray-200 p-2">
                ...
                />
                {customProduct &&
                  !DOLLHOUSE_PRODUCT_TYPES.some((product) => product === customProduct) && (
                    <button
                      type="button"
              ...
              <div className="max-h-60 overflow-auto py-1">
                {filteredProducts.map((product) => (
                  <button
                    key={product}
                    type="button"
                    onClick={() => dispatch({ type: 'setProduct', value: product })}
            ...
            <>
              ...
              <p className="border-b border-gray-50 px-3 py-1.5 text-[11px] text-gray-500">
                ...
                <code className="rounded bg-gray-100 px-0.5">
                  {`{{#each dollhouse.${state.product}.visibility}}…{{/each}}`}
                </code>{' '}
                block.
              </p>
              <div className="max-h-60 overflow-auto py-1">
