...
/** Product category: camelCase key (API response) -> snake_case key (evaluation form). */
 ...
 */
export function getProductImagesFromInput(input: Record<string, unknown> | null | undefined): ProductImageItem[] {
  if (!input) return [];
